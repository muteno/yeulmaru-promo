...
SHORT = {"SEM": "섬박람회 음악회", "JJH": "조재혁", "GND": "그날들", "CHJ": "춘자씨",
         "TRP": "트리플 빌", "C18": "18세기 시대악기", "PNP": "피아노 & 피아노"}
...
E = [
    ...
    ("2026-08-14", "15:00", "인스타그램",   "이미지", "JJH", "영화관 대신 공연장 ① 만원의 행복", "학생 전학년 1만원 정액 2종(조재혁·18세기)",     "심희은"),
    ("2026-08-19", "11:00", "카카오톡",     "이미지", "C18", "티켓오픈 안내",               "10/22(목) 소극장 · 학생 전학년 1만원",             "황세웅"),
    ("2026-08-19", "14:00", "인스타그램",   "이미지", "C18", "티켓오픈 카드",               "시대악기 = 거트현·바깥으로 휜 활·목재 관악기",      "심희은"),
    ("2026-08-21", "15:00", "인스타그램",   "이미지", "JJH", "예울마루 모차르트 270",       "탄생 270주년 · 9/12 현대피아노 ↔ 10/22 시대악기",  "심희은"),
    ...
    ("2026-10-16", "15:00", "인스타그램",   "이미지", "C18", "시대악기 소개",               "10/22 소극장 · 바로크의 정점과 고전의 새벽",        "심희은"),
