...
<div class="card"><div class="row">
  ...
  <div class="shot"><span class="tag">후 — 쉼</span><img alt="후: 접힘 상태(전과 동일 기하)" src="${b64('260813_예울이_호버확장_후_쉼.png')}"><div class="cap">접힘 칸 <b>223px = 전과 Δ0</b>. 막대 카드도 414px 그대로. 대화는 입력줄 쪽에 붙는다(메신저 규약).</div></div>
...
<div class="stage">
  ...
  <div style="flex:1 1 300px;min-width:270px">
    <div class="ctl">
      <label>길이</label><input type="range" id="d" min="120" max="900" step="10" value="460"><span class="val" id="dv">460ms</span>
      ...
      <label>접힘 칸</label><input type="range" id="h" min="150" max="320" step="1" value="223"><span class="val" id="hv">223px</span>
    </div>
...
<b>접힘 칸</b> <code>--rise-h</code> = 로그창 <code>clamp(96px,16vh,190px)</code>(종전 값 그대로) + 입력줄·테두리 <code>--rise-foot</code>(<code>_memAiPaint</code>가 <code>.cb-foot</code> 실측으로 덮어씀 · 실측 61+2=63).<br>
...
· 무대 칸 519×651 = 1500×1000 실측 고정값. 실제 앱은 창 크기에 따라 <code>16vh</code>로 접힘 칸이 신축한다(760×900 실측 = 207px).<br>
...
<script>
var PRESETS=[
 {n:'현행 = 배선값 ★',d:460,e:'cubic-bezier(.215,.61,.355,1)',i:100,o:180,open:0,h:223},
 {n:'빠릿',d:280,e:'cubic-bezier(.4,0,.2,1)',i:60,o:120,open:0,h:223},
 {n:'느긋',d:640,e:'cubic-bezier(.22,.9,.36,1)',i:160,o:260,open:0,h:223},
 {n:'절반만 올라감',d:460,e:'cubic-bezier(.215,.61,.355,1)',i:100,o:180,open:45,h:223}
];
...
function apply(){var v=cur();
 ...
 var base=(v.d===460&&v.e==='cubic-bezier(.215,.61,.355,1)'&&v.i===100&&v.o===180&&v.open===0&&v.h===223);
 $('out').textContent=
  ...
  '.cb-rise-col{--rise-h:'+(v.h===223?'calc(var(--rise-log) + var(--rise-foot))   /* 계승 = 실측 160+63 */':v.h+'px   /* 갱신 후보 — 현행 223(=clamp(96,16vh,190)+63) */')+'}\\n'+
