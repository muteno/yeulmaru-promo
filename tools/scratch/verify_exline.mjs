...
// ⑥-2 [260803 2차 운영자 「초록은 그대로, 파랑은 아래로 — 장도쪽이니까」] 7층 + 야외(장도 없음) = 야외가 아랫 전시선
r = run([{ lane: L['7층'], s: '2026-07-21', e: '2026-11-01' }, { lane: L['야외'], s: '2026-08-25', e: '2026-10-25' }], '2026-08-27');
ok('7층+야외 → [7층, 야외] = 초록 위·파랑 아래', eq(r, [G, O]), r);

// ⑥-3 야외만 = 아랫줄 1줄(위는 안 붙는다)
r = run([{ lane: L['야외'], s: '2026-08-25', e: '2026-10-25' }], '2026-08-27');
ok('야외만 → [야외] = 아랫 전시선', eq(r, [O]), r);

// ⑦ 야외 + 장도(7층 공백) = 야외가 맨 위로 비켜서고 장도가 아랫줄 사수 · 가운데(7층 자리)는 투명
